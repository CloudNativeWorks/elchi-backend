...
var AllowedEndpoints = []string{
	...
	"/api/v3/inventory/consumers",
	"/api/v3/inventory/consumers/:hash",
	"/api/v3/inventory/changes",
	"/api/v3/inventory/snapshots",
	"/api/v3/inventory/cleanup-stale",
	"/api/v3/inventory/rebaseline-scores",
	"/api/v3/inventory/:id",
	"/api/v3/inventory/:id/events",
	"/api/v3/inventory/:id/stats",
	"/api/v3/inventory/:id/current-posture",
