...
func (p *NetworkProcessor) buildNetworkStateRequest(op models.OperationClass, requestDetails models.RequestDetails) (any, error) {
...
func (p *NetworkProcessor) buildNetplanGetRequest(op models.OperationClass, requestDetails models.RequestDetails) (any, error) {
...
func (p *NetworkProcessor) buildNetplanRollbackRequest(op models.OperationClass, requestDetails models.RequestDetails) (any, error) {
...
func (p *NetworkProcessor) buildTableListRequest(op models.OperationClass, requestDetails models.RequestDetails) (any, error) {
...
func (p *NetworkProcessor) buildLegacyNetplanRequest(op models.OperationClass, requestDetails models.RequestDetails) (any, error) {
