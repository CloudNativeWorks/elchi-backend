...
// IsDefaultResource checks for default users, groups, and projects using hardcoded names
...
// IsDefaultXDSResource checks if XDS or extension resource is default by checking metadata.is_default field
