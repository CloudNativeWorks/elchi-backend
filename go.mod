...
require (
	...
	github.com/CloudNativeWorks/versioned-go-control-plane v0.14.0-envoy1.38.3
...
require (
	...
	github.com/CloudNativeWorks/versioned-go-control-plane/ratelimit v1.38.3 // indirect
