...
require (
	...
	github.com/CloudNativeWorks/versioned-go-control-plane v0.13.4-envoy1.35.2
...
require (
	...
	github.com/CloudNativeWorks/versioned-go-control-plane/ratelimit v1.35.2 // indirect
