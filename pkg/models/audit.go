...
type AuditEntry struct {
	...
	// Resource Operation Context - distinguishes between save vs publish operations
	SaveOrPublish string `json:"save_or_publish,omitempty" bson:"save_or_publish,omitempty"`
